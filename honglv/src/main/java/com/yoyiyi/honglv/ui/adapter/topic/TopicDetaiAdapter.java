 ...
 */
public class TopicDetaiAdapter extends BaseQuickAdapter<TopicDetail.ListBean> {
   // private Context mContext;

    public TopicDetaiAdapter( List<TopicDetail.ListBean> data) {
        super(R.layout.item_bangumi_recycler, data);
    }

    @Override
    protected void convert(BaseViewHolder holder, TopicDetail.ListBean topicDetail) {
