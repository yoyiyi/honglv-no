...
import com.yoyiyi.honglv.ui.adapter.news.NewsAnotherAdapter;
 ...
 */
public class NewsAnotherFragment extends BaseFragment implements BaseQuickAdapter.RequestLoadMoreListener, SwipeRefreshLayout.OnRefreshListener,
    ...
    private List<Zhihu.StoriesBean> mNews = new ArrayList<>();
    private NewsAnotherAdapter mAdapter;
    ...
    public static NewsAnotherFragment newInstance(int index) {
        Bundle bundle = new Bundle();
        bundle.putInt(NEWBANGUMI_INDEX, index);
        NewsAnotherFragment fragment = new NewsAnotherFragment();
    ...
    private void initRecyclerView() {
        ...
        mAdapter = new NewsAnotherAdapter(new ArrayList());
        addHeader();
    ...
    private void doHttpConnection() {
        HttpManager.getHttpManager().getHttpService()
                ...
                .subscribe(news -> {
                    mTotalCount = news.getStories().size();
                    finishTask();
